...
public class TestCafeDebugProgramRunner extends AsyncProgramRunner {
    private static final Logger LOG = Logger.getInstance(TestCafeDebugProgramRunner.class);

    @NotNull
    @Override
    public String getRunnerId() {
        return "TestCafeJavaScriptTestRunnerDebug";
    }
    ...
    protected Promise<RunContentDescriptor> execute(@NotNull ExecutionEnvironment environment, @NotNull RunProfileState state) throws ExecutionException {
        ...
        return TestcafeKt.prepareTestCafeDebugger(environment.getProject(), debuggableWebBrowser, () -> {
