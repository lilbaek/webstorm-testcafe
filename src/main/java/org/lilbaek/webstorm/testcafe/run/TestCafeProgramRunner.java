...
public class TestCafeProgramRunner extends GenericProgramRunner {
    ...
    public String getRunnerId() {
        return "TESTCAFE_WEBSTORM_PROGRAM_RUNNER";
    }

    @Override
    public boolean canRun(@NotNull String executorId, @NotNull RunProfile profile) {
        return DefaultRunExecutor.EXECUTOR_ID.equals(executorId) && profile instanceof TestCafeRunConfiguration;
    }
}